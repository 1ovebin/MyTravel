...
<style scoped>
  ...
  .header-fixed{z-index: 99;position: fixed;top: 0;left: 0;right: 0;height: .88rem;line-height: .88rem;text-align: center;color: #fff;background: #00BCD4; font-size: .32rem;}
